...
<%@taglib prefix="p" uri="http://ww.yyf.tag"%>
...
<script>
	...
	function findCart(){
		if("${sessionScope.cart}" == "{}"){
			...
			window.location.href="${pageContext.request.contextPath}/client/order.jsp";
		}
									...
									<tr>
										<td>
											...
											<div style="text-align:right; margin-top:10px">
												<a href="${pageContext.request.contextPath}/client/products/findProductByCategory.do">
													<img src="images/gwc_jx.gif" border="0" />
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<%-- <a href="${pageContext.request.contextPath}/client/order.jsp" onclick="findCart();">
													<img src="${pageContext.request.contextPath}/client/images/gwc_buy.gif" border="0" />
												</a> --%>
												<input type="image" src="${pageContext.request.contextPath}/client/images/gwc_buy.gif" onclick="findCart();"/>
											</div>
										</td>
									</tr>
								</table>
