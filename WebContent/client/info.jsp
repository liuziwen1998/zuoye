...
function checkpnum(id, totalCount){
	totalCount = parseInt(totalCount);
	
	if(totalCount<=0){
		alert("商品库存不足！");
	}else{
		window.location.href = "${pageContext.request.contextPath}/client/cart/addCart.do?id="+id;
	}
}
</script>
									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="#">
													<img src="${pageContext.request.contextPath }/client/images/buybutton.gif" border="0" onclick="checkpnum('${p.id}', '${p.pnum }');" /> 
												</a>
											</div>
										</td>
