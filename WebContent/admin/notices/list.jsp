							...
							<c:forEach items="${notices}" var="n">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
										<a href="${pageContext.request.contextPath}/admin/notice/findNoticeById.do?id=${n.n_id}">
											<img src="${pageContext.request.contextPath}/admin/images/i_edit.gif" border="0" style="CURSOR: hand"> 
										</a>
									</td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/notice/removeNoticeById.do?id=${n.n_id}">
											<img
						...
						<div class="pagination">
									<ul>
										<yyf:pager pageIndex="${requestScope.pageModel.pageIndex}" 
	  	                                           ...
	  	                                           submitUrl="${pageContext.request.contextPath}/admin/notice/findListNotice.do?pageIndex={0}"/>
									</ul>
								</div>
					</td>
				</tr>
